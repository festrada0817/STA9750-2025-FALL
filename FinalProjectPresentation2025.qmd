...
For a more detailed description of the modeling steps and diagnostics, see [here](https://festrada0817.github.io/STA9750-2025-FALL/Q1.html).
...
Building on these tract-level patterns, the next map shifts from where low-access tracts are located to who is actually living in them, by mapping the population residing in rural areas that meet the USDA’s low-access definition of being more than a half mile in urban contexts or 10 miles in rural contexts from a supermarket or large grocery store. Instead of treating each tract equally, the map weights tracts by the number of residents exposed to low food access, revealing that roughly 54 million people nationwide are affected and that rural low-access populations are especially concentrated in large, populous states such as California, Texas, and Florida. By summarizing the distribution of affected residents across rural low-access tracts, the analysis shows that the mean exposed population is about 4.65 million while the median is 3.02 million, suggesting that a combination of a few very high-burden states and many moderately affected states together generate a sizable rural population facing structural barriers to reaching healthy food outlets. Taken together, the spatial patterns and population counts underscore that low access is not only a geographic phenomenon but also a population-scale one, pointing to the importance of targeting interventions such as transportation investments, mobile markets, or incentives for new food retailers toward rural regions where large numbers of people are simultaneously distant from supermarkets and concentrated in the same vulnerable tracts.
![](2.2.jpeg)
